        ...
        <Flex w="full" direction="column" mt="4">
            ...
            <Stack w="full" direction={{ base: "column", md: "row" }}>
                <Field.Root invalid={!!errors.phone || !!serverErrors.phone}>
                    ...
                    <Input value={company?.phone} {...register("phone")} placeholder="Telefone"/>
                ...
                <Field.Root invalid={!!errors.contactEmail || !!serverErrors.contactEmail}>
                    ...
                    <Input value={company?.contactEmail} {...register("contactEmail")} placeholder="Digite o nome do cargo"/>
            ...
            <Stack w="full" direction={{ base: "column", md: "row" }}>
                <Field.Root invalid={!!errors.instagram || !!serverErrors.instagram}>
                    ...
                    <Input value={company?.instagram} {...register("instagram")} placeholder="Digite o nome do cargo"/>
                ...
                <Field.Root invalid={!!errors.facebook || !!serverErrors.facebook}>
                    ...
                    <Input value={company?.facebook} {...register("facebook")} placeholder="Digite o nome do cargo"/>
                ...
                <Field.Root invalid={!!errors.linkedin || !!serverErrors.linkedin}>
                    ...
                    <Input value={company?.linkedin} {...register("linkedin")} placeholder="Digite o nome do cargo"/>
                    <Field.HelperText>Opcional</Field.HelperText>
